...
namespace TEngine
{
    ...
    public class ResConfigUtil
    {
        ...
        public static List<T>? ReadConfigListRes<T>(string fileName = "")
        {
            ...
            string resPath = string.Format("{0}.json", fileName);
            string jsonStr = ConfigHelper.GetJsonFile(resPath);
            ...
            var jsonData = JsonHelper.Instance.Deserialize<List<T>>(jsonStr);
            list = jsonData;
            return list;
        }
        ...
        public static Dictionary<string, T>? ReadConfigRes<T>(string fileName = "")
        {
            ...
            var jsonData = JsonHelper.Instance.Deserialize<Dictionary<string, T>>(jsonStr);
            dic = jsonData;
            return dic;
        }
        ...
        public static Dictionary<int, T> ReadConfigResIntKey<T>(string fileName = "")
        {
            ...
            var jsonData = JsonHelper.Instance.Deserialize<Dictionary<int, T>>(jsonStr);
            dic = jsonData;
            return dic;
        }
